...
public class OFR_Assign_activity extends AppCompatActivity {
    private static LayoutInflater inflater=null;
    ListView listView;
    DatabaseClass database;
    ArrayList<Ofr_Assign_model> arrayList;
 private CustomListAdapter customListAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ofr__assign_activity);
        addAssignActiviy();
    }

    public void addAssignActiviy(){
        listView =(ListView)findViewById(R.id.mLvAssign);
        customListAdapter =new CustomListAdapter(getApplicationContext(), arrayList);
